...
// Test subclass that uses MockWebSocket as the WebSocket implementation
...
describe('WebSocket Transport', () => {
  ...
  describe('WebSocketTransport', () => {
    describe('initialization', () => {
      ...
      it('should accept custom configuration', () => {
        const customTransport = new TestWebSocketTransport({
    ...
    describe('connect', () => {
      ...
      it('should reject if connection times out', async () => {
        const timeoutTransport = new TestWebSocketTransport({
    ...
    describe('send', () => {
      ...
      it('should throw if not connected', () => {
        ...
        expect(() => transport.send('test')).toThrow('Cannot send data: connection is closed');
      });
    });
  ...
  describe('interface compliance', () => {
    it('should implement IWebSocketTransport interface', () => {
      const transport: IWebSocketTransport = new TestWebSocketTransport({});
